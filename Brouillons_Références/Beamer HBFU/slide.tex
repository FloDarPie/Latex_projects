...
\author{林某某}
\title{HBFU Beamer Theme}
\subtitle{开题报告}
\institute{河北金融学院大数据科学学院}
\date{\today}
\usepackage{Westlake}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.5\linewidth]{pic/HBFU.jpg}
        \end{center}
    \end{figure}
\end{frame}
...
%     \begin{figure}[htpb]
%         \centering
%         \includegraphics[width=0.2\linewidth]{pic/HBFU.pdf}
%         \caption{这个校徽就是矢量图}
%     \end{figure}
% \end{frame}
