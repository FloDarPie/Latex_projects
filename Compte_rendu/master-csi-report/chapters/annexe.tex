...
L'ensemble de ces règles a permis de décrire formellement le comportement de l'extension \texttt{checkct}, qui permet de vérifier les propriétés temps constants d'un programme. 
