...
\begin{enumerate}
  \item[\texttt{max depth}] Arrêt par limitations du nombre d'instructions à analyser, cela permet de réduire la profondeur des branchements conditionnels à explorer et de limiter le risque de parcours infini.
