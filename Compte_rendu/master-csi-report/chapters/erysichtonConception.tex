...
Sans reprendre les explications du fonctionnement de Binsec, voir le chapitre \ref{chap:automateVerifOutils}, l'analyse se réalise sur un fichier binaire à l'aide d'instructions à adjoindre. Avec ce point de départ, nous commençons à construire notre carnet de spécifications.
