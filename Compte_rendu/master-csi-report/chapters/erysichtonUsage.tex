...
Les données détaillées peuvent être consulté en annexe \ref{tab:resultats_finaux}. En l'état, l'analyse rapporte entre 139 et 168 fichiers dont l'analyse n'a pus se terminer. Il faudrait observer plus en détails ces fichiers pour cibler   \medbreak
...
Le détails des valeurs est rapporté en annexe \ref{table:detail_unknown}.
